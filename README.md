...
(function(){
  ...
  const singersDB = [
	...
	{name: "刘惜君", enName: "Sara Liu", debutYear: "2004", debutDetail: "2004年凭借单曲《贝壳风铃》崭露头角，2009年获《快乐女声》全国五强出道", genre: ["华语流行", "独立摇滚", "影视原声"],reps: ["我很快乐", "怎么唱情歌", "大风吹"], bio: "温婉深情的女歌手，以高辨识度嗓音和影视金曲闻名，近年凭《大风吹》再度翻红。",bio_en: "Warm and soulful female singer known for her distinctive voice and film soundtracks.", bio_ja: "温かく感情豊かな女性歌手。特徴的な声質と映画主題歌で知られる。", region: "国内", gender: "女", hot: 101},
	  { name: "成龙", enName: "Jackie Chan", debutYear: "1962", debutDetail: "1962年以童星身份参演电影出道，1978年凭《蛇形刁手》《醉拳》走红", genre: ["动作电影", "喜剧动作", "影视原声"], reps: ["醉拳", "警察故事", "A计划"],bio: "国际知名动作演员与导演，以惊险特技和幽默风格闻名，开创功夫喜剧类型。",bio_en: "World-famous action star known for stunt-driven kung fu comedy films.", bio_ja: "スタントとカンフーコメディで世界的に知られるアクション俳優。", region: "港澳台", gender: "男", hot: 102 },
	{name: "张国荣", enName: "Leslie Cheung", debutYear: "1977", debutDetail: "1977年参加歌唱比赛出道，1984年凭《Monica》走红乐坛", genre: ["华语流行", "粤语流行", "影视原声"], reps: ["Monica", "沉默是金", "倩女幽魂"], bio: "极具影响力的歌手与演员，以独特气质和经典影视音乐作品影响华语文化。", bio_en: "Iconic singer and actor with lasting influence on Cantopop and cinema.", bio_ja: "音楽と映画で大きな影響を与えた伝説的アーティスト。", region: "港澳台", gender: "男", hot: 103}
  ];
